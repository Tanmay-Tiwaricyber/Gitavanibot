...
BOT_TOKEN = "6690051999:AAGUYuEcsbhynzpvL58dAFH9XxYnxB6kgJA"
...
async def send_hourly_quotes(context: ContextTypes.DEFAULT_TYPE):
    ...
    for chat_id in PRIVATE_CHATS.copy():
        try:
            ...
            # Remove chat from the set if there's an error
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.effective_chat.type == 'private':
        ...
        await update.message.reply_text(
            ...
            "I will send random shlokas every hour to you and to the Geeta quotes section in @cbseiansss group.\n"
            "Use /help to see available commands.\n\n"
            "Use /stopquotes to stop receiving hourly quotes."
        )
    else:
        await update.message.reply_text(
